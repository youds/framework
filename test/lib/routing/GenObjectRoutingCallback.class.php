...
class GenObjectRoutingCallback extends YoudsFrameworkRoutingCallback
{
	/**
	...
	{
		if(isset($userParameters['value']) && $userParameters['value'] instanceof YoudsFrameworkIRoutingValue) {
