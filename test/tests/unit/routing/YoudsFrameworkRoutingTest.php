...
class YoudsFrameworkRoutingTest extends YoudsFrameworkPhpUnitTestCase
{
	protected $routing;
	...
	{
		$this->routing = new YoudsFrameworkTestingRouting();
	...
	public function testExecuteEmptyInput()
	{
		...
		$container = $this->routing->execute();
		$this->assertEquals(YoudsFrameworkConfig::get('actions.error_404_action'), $container->getActionName());
		$this->assertEquals(YoudsFrameworkConfig::get('actions.error_404_module'), $container->getModuleName());
		$this->assertEquals(array(), YoudsFrameworkContext::getInstance(null)->getRequest()->getAttribute('matched_routes', 'org.youds.routing'));
	}
	...
	public function testExecuteSimpleInput()
	{
		$this->routing->setInput('/');
		$container = $this->routing->execute();
		$this->assertEquals(YoudsFrameworkConfig::get('actions.default_action'), $container->getActionName());
		$this->assertEquals(YoudsFrameworkConfig::get('actions.default_module'), $container->getModuleName());
		$this->assertEquals(array('index'), YoudsFrameworkContext::getInstance(null)->getRequest()->getAttribute('matched_routes', 'org.youds.routing'));
	}
	
	public function testExecuteUserAuthenticated()
	{
		$ctx = YoudsFrameworkContext::getInstance(null);
		...
		$this->assertEquals(array('user_logged_in'), $ctx->getRequest()->getAttribute('matched_routes', 'org.youds.routing'));
	...
	{	
		...
		$this->assertEquals(array('server'), $ctx->getRequest()->getAttribute('matched_routes', 'org.youds.routing'));
	}
	...
	{	
		...
		$this->assertEquals(array('testingsource'), $ctx->getRequest()->getAttribute('matched_routes', 'org.youds.routing'));
	}
	...
	public function testMatchWithParam()
	{
		...
		$container = $this->routing->execute();
		$this->assertEquals(array('with_param'), YoudsFrameworkContext::getInstance(null)->getRequest()->getAttribute('matched_routes', 'org.youds.routing'));
	...
	public function testMatchWithMultipleParams()
	{
		...
		$container = $this->routing->execute();
		$this->assertEquals(array('with_two_params'), YoudsFrameworkContext::getInstance(null)->getRequest()->getAttribute('matched_routes', 'org.youds.routing'));
		$this->assertEquals(5, $ctx->getRequest()->getRequestData()->getParameter('number'));
	...
	public function testNonMatchingCallback()
	{
		...
		$container = $this->routing->execute();
		$this->assertEquals(array('callbacks'), YoudsFrameworkContext::getInstance(null)->getRequest()->getAttribute('matched_routes', 'org.youds.routing'));
		$this->assertEquals(YoudsFrameworkConfig::get('actions.error_404_module'), $container->getModuleName());
		$this->assertEquals(YoudsFrameworkConfig::get('actions.error_404_action'), $container->getActionName());
	}
	...
	public function testMatchingCallback()
	{
		...
		$container = $this->routing->execute();
		$this->assertEquals(array('callbacks', 'callbacks.matching_callback'), $ctx->getRequest()->getAttribute('matched_routes', 'org.youds.routing'));
	...
	public function testEmptyDefaultValue() {
		...
		$container = $this->routing->execute();
		$rd = YoudsFrameworkContext::getInstance(null)->getRequest()->getRequestData();
