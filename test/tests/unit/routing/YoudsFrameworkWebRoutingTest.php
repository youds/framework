...
class YoudsFrameworkWebRoutingTest extends YoudsFrameworkPhpUnitTestCase
{
	protected $routing;
	...
	{
		$this->routing->setInput('/test_ticket_444/youds/13/');
		$this->routing->execute();
		$url = $this->routing->gen('test_ticket_444', array('page' => 14));
		$this->assertEquals('/test_ticket_444/youds/14/', $url);
