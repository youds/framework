...
class YoudsFrameworkWebRoutingServerCasesTest extends YoudsFrameworkUnitTestCase
{
	protected $_r = null;
	...
	public function setUp()
	{
		...
		$this->_ENV = $_ENV;
		$this->_GET = $_GET;
		YoudsFrameworkConfig::set('core.use_routing', true);
	}
	...
	public function testCases($export)
	{
		...
		// the superglobals.
		$ctx = YoudsFrameworkContext::getInstance('routing-server-cases');
		$_SERVER = $export['_SERVER'];
		$_ENV = $export['_ENV'];
		$_GET = $export['_GET'];
		$ctx->getRequest()->initialize($ctx);
		$this->_r = new YoudsFrameworkWebRouting();
	...
	public function tearDown()
	{
		...
		YoudsFrameworkConfig::set('core.use_routing', false);
	}
