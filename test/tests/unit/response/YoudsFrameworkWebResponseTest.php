...
class TestYoudsFrameworkWebResponse extends YoudsFrameworkWebResponse
{
...
class YoudsFrameworkWebResponseTest extends YoudsFrameworkUnitTestCase
{
	
	/**
	 * @var \TestYoudsFrameworkWebResponse
	 */
	private $_r = null;

	public function setUp()
	{
		$this->_r = new TestYoudsFrameworkWebResponse();
	...
	public function testSetGetHttpStatusCode()
	{
		...
		try {
			...
			$this->fail('Expected YoudsFrameworkException was not thrown!');
		} catch(YoudsFrameworkException $e) {
			$this->assertEquals('400', $r->getHttpStatusCode());
		}
