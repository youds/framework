...
class YoudsFrameworkWebRequestDataHolderCookieTest extends YoudsFrameworkWebRequestDataHolderTest
{
	/**
	...
	{
		$dh = new YoudsFrameworkWebRequestDataHolder(array());
	...
	public function testMergeCookies()
	{
		...
		$dh2 = new YoudsFrameworkWebRequestDataHolder(
			array(
				YoudsFrameworkWebRequestDataHolder::SOURCE_COOKIES => array(
					'flat' => 'flatvalue merged',
					'set'  => 'setCookies',
				)
			)
	...
	public function testMergeCookies2()
	{
		...
		$dh2 = new YoudsFrameworkRequestDataHolder(
			array(
				YoudsFrameworkWebRequestDataHolder::SOURCE_COOKIES => array(
					'flat' => 'flatvalue merged',
					'set'  => 'setCookies',
		...
		$this->assertEquals(
			$expected,
			$dh->getCookies(),
			'Failed asserting that cookies from a dataholder not implementing YoudsFrameworkICookiesRequestDataHolder are not merged.'
		);
	}
