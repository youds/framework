...
class YoudsFrameworkWebRequestDataHolderParameterTest extends YoudsFrameworkWebRequestDataHolderTest
{	    
	/**
	...
	public function testMergeParameters()
	{
		...
		$dh2 = new YoudsFrameworkWebRequestDataHolder(
			array(
				YoudsFrameworkWebRequestDataHolder::SOURCE_PARAMETERS => array(
					'flat' => 'flatvalue merged',
					'set'  => 'setCookies',
				)
			)
