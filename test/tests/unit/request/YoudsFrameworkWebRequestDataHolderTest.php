<?php
abstract class YoudsFrameworkWebRequestDataHolderTest extends YoudsFrameworkUnitTestCase
{
	protected function getDefaultDataHolder()
	{
		return new YoudsFrameworkWebRequestDataHolder(
			array(
				YoudsFrameworkWebRequestDataHolder::SOURCE_COOKIES => $this->getDefaultNestedInputData(),
				YoudsFrameworkWebRequestDataHolder::SOURCE_PARAMETERS => $this->getDefaultNestedInputData(),
				YoudsFrameworkWebRequestDataHolder::SOURCE_HEADERS => $this->getDefaultHeaders(),
			)
		);
	}
