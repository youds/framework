...
class BaseCalendarTest extends YoudsFrameworkPhpUnitTestCase 
{
	protected $tm;
	...
	protected function dateToString($time)
	{
		...
		$time->getTime();
		$format = new YoudsFrameworkDateFormatter('EEE MMM dd HH:mm:ss zzz yyyy');
		return $format->format($time, 'gregorian', $this->tm->getCurrentLocale());
	}

	public function setUp()
	{
		$this->tm = YoudsFrameworkContext::getInstance()->getTranslationManager();
	}
}
