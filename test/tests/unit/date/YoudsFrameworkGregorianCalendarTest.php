...
class YoudsFrameworkGregorianCalendarTest extends YoudsFrameworkUnitTestCase
{
	private $cal;
	public function setUp()
	{
		$this->cal = new YoudsFrameworkGregorianCalendar($this->getContext()->getTranslationManager()->createTimeZone('Europe/Berlin'));
		// 2009-02-21 12:30:20
