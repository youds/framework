...
class YoudsFrameworkOroperatorValidatorTest extends YoudsFrameworkUnitTestCase
{
	public function testvalidate()
	{
		$vm = $this->getContext()->createInstanceFor('validation_manager');
		$vm->clear();
		$o = $vm->createValidator('YoudsFrameworkOroperatorValidator', array(), array(), array('severity' => 'error'));
