...
class YoudsFrameworkXoroperatorValidatorTest extends YoudsFrameworkUnitTestCase
{
	public function testvalidate()
	{
		$vm = $this->getContext()->createInstanceFor('validation_manager');
		$vm->clear();
		$o = $vm->createValidator('YoudsFrameworkXoroperatorValidator', array(), array(), array('severity' => 'error'));
