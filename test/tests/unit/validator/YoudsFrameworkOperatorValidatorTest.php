...
class MyOperatorValidator extends YoudsFrameworkOperatorValidator
{
...
class YoudsFrameworkOperatorValidatorTest extends YoudsFrameworkUnitTestCase
{
	private $context;
	private $vm;
	...
	public function testExecute()
	{
		...
		$this->assertEquals($v->execute(new YoudsFrameworkRequestDataHolder()), YoudsFrameworkValidator::SUCCESS);
