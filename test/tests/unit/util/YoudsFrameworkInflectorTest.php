...
class YoudsFrameworkInflectorTest extends YoudsFrameworkPhpUnitTestCase
{
	/**
	...
	{
		$this->assertEquals($singular, YoudsFrameworkInflector::singularize($plural));
	}
	...
	{
		$this->assertEquals($plural, YoudsFrameworkInflector::pluralize($singular));
	}
