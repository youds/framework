...
class YoudsFrameworkDecimalFormatterTest extends YoudsFrameworkPhpUnitTestCase
{
	/**
	 * @dataProvider dataFormatNumber
	 */
	public function testFormatNumber($format, $input, $expected) {
		$df = new YoudsFrameworkDecimalFormatter($format);
	...
	{
		$hasExtraChars = false;
		$parsed = YoudsFrameworkDecimalFormatter::parse($input, null, $hasExtraChars);
