<?php
if(!class_exists('YoudsFrameworkVirtualArrayPath')) {
	include(__DIR__ . '/../../../../src/util/YoudsFrameworkVirtualArrayPath.class.php');
}

if(!class_exists('YoudsFrameworkArrayPathDefinition')) {
	include(__DIR__ . '/../../../../src/util/YoudsFrameworkArrayPathDefinition.class.php');
}

class YoudsFrameworkVirtualArrayPathTest extends YoudsFrameworkPhpUnitTestCase
{
	...
	{
		$obj = new YoudsFrameworkVirtualArrayPath("path");
		$this->assertTrue($obj->isAbsolute());
		$obj2 = new YoudsFrameworkVirtualArrayPath("");
		$this->assertTrue($obj2->isAbsolute());
		$obj3 = new YoudsFrameworkVirtualArrayPath(0);
		$this->assertTrue($obj3->isAbsolute());
		$obj4 = new YoudsFrameworkVirtualArrayPath("[path]");
	...
	public function testToString()
	{
		...
		$obj = new YoudsFrameworkVirtualArrayPath('one[two]');
		$this->assertEquals('one[two]', $obj->__toString());
		$obj = new YoudsFrameworkVirtualArrayPath('one[two][three]');
	...
	{
		$obj = new YoudsFrameworkVirtualArrayPath("path[jump]");
	...
	{
		$obj4 = new YoudsFrameworkVirtualArrayPath("path[jump]");
	...
	{
		$obj = new YoudsFrameworkVirtualArrayPath("path[33]");
	...
	{
		$obj = new YoudsFrameworkVirtualArrayPath("path[jump][sip]");
		$array = array(
			"path" => array(
				"jump" => array (
					"sip" => "whatever"
		...
		$obj2 = new YoudsFrameworkVirtualArrayPath("path");
		$this->assertTrue($obj2->hasValue($array));  // true

		$obj3 = new YoudsFrameworkVirtualArrayPath("path[jump]");
		$this->assertTrue($obj3->hasValue($array));  // true

		$obj4 = new YoudsFrameworkVirtualArrayPath("path[foo]");
	...
	public function testGetValue()
	{
		...
		$obj3 = new YoudsFrameworkVirtualArrayPath("");
		$this->assertEquals($array, $obj3->getValue($array));
		$obj4 = new YoudsFrameworkVirtualArrayPath("notthere");
