...
if(!class_exists('YoudsFrameworkParameterHolder')) {
	include(__DIR__ . '/../../../../src/util/YoudsFrameworkParameterHolder.class.php');
}

if(!class_exists('YoudsFrameworkAttributeHolder')) {
	include(__DIR__ . '/../../../../src/util/YoudsFrameworkAttributeHolder.class.php');
}

class MyYoudsFrameworkAttributeHolder extends YoudsFrameworkAttributeHolder {}

class YoudsFrameworkAttributeHolderTest extends YoudsFrameworkPhpUnitTestCase
{
	...
	{
		$p = new MyYoudsFrameworkAttributeHolder(array('baz' => 'boo'));
		$this->assertEquals('org.youds', $p->getDefaultNamespace());
	}

	public function testClearAttributes()
	{
		$data = array('baz' => 'boo');
		$p = new MyYoudsFrameworkAttributeHolder();
	...
	public function testRemoveReturnsByReference()
	{
		...
		$ph = new MyYoudsFrameworkAttributeHolder();
