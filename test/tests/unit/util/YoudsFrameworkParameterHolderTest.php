...
//class YoudsFrameworkParameterHolderTest extends YoudsFrameworkUnitTestCase
class YoudsFrameworkParameterHolderTest extends YoudsFrameworkPhpUnitTestCase
{
	...
	public function testConstructAndGetParameters()
	{
		...
		$p = new YoudsFrameworkParameterHolder($data);
		$p2 = new YoudsFrameworkParameterHolder(array('bla'));
		$p3 = new YoudsFrameworkParameterHolder();
	...
	public function testGetParametersIntegerIndex()
	{
		...
		$p = new YoudsFrameworkParameterHolder($data2);
	...
	{
		$p = new YoudsFrameworkParameterHolder();
	...
	public function testClear()
	{
		...
		$p = new YoudsFrameworkParameterHolder($data3);
		$p->clearParameters();
		$this->assertEquals(array(), $p->getParameters());
	}
	...
	{
		$ph = new YoudsFrameworkParameterHolder();
