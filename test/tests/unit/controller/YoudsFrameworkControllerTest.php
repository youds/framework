...
class TestController extends YoudsFrameworkController
{
	public function redirect($to)
	{
		throw new YoudsFrameworkException('N/A');
	}
}
 ...
 */
class YoudsFrameworkControllerTest extends YoudsFrameworkUnitTestCase
{
	...
	public function testNewController()
	{
		...
		$this->assertInstanceOf('YoudsFrameworkController', $controller);
		$this->assertInstanceOf('YoudsFrameworkContext', $controller->getContext());
	...
	public function testactionFileExists()
	{
		...
		$this->assertTrue(file_exists(YoudsFrameworkConfig::get('core.app_dir') . '/modules/ControllerTests/actions/ControllerTestAction.class.php'));
		$this->assertFalse(file_exists(YoudsFrameworkConfig::get('core.app_dir') . '/modules/ControllerTests/actions/BunkAction.class.php'));
		$this->assertFalse(file_exists(YoudsFrameworkConfig::get('core.app_dir') . '/modules/Bunk/actions/BunkAction.class.php'));
		$controller = $this->_controller;
		$this->assertEquals(YoudsFrameworkConfig::get('core.app_dir') . '/modules/ControllerTests/actions/ControllerTestAction.class.php', $controller->checkActionFile('ControllerTests', 'ControllerTest'));
	...
	public function testGetActionFromModule()
	{
		...
		$this->assertInstanceOf('YoudsFrameworkAction', $action);

	}

	/**
	 * @expectedException YoudsFrameworkFileNotFoundException
	 */
	...
	public function testGetOutputTypeInfo()
	{
		...
		try {
			...
			$this->fail('Expected YoudsFrameworkException not thrown!');
...
/* 
	// TODO: moved to YoudsFrameworkResponse
	public function testsetContentType()
	{
		$controller = YoudsFrameworkContext::getInstance('test')->getController();
	...
	function testgenURL()
	{
		$routing = YoudsFrameworkContext::getInstance('test')->getRouting();
