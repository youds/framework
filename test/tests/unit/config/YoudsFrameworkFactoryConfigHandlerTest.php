...
class FCHTestDispatchFilter     implements YoudsFrameworkIGlobalFilter {
...
class FCHTestExecutionFilter    implements YoudsFrameworkIActionFilter {
	public function executeOnce(YoudsFrameworkFilterChain $filterChain, YoudsFrameworkExecutionContainer $container) {}
	public function execute(YoudsFrameworkFilterChain $filterChain, YoudsFrameworkExecutionContainer $container) {}
	public final function getContext() {}
	public function initialize(YoudsFrameworkContext $context, array $parameters = array()) {}
...
class FCHTestSecurityFilter     implements YoudsFrameworkIActionFilter, YoudsFrameworkISecurityFilter {
	public function executeOnce(YoudsFrameworkFilterChain $filterChain, YoudsFrameworkExecutionContainer $container) {}
	public function execute(YoudsFrameworkFilterChain $filterChain, YoudsFrameworkExecutionContainer $container) {}
	public final function getContext() {}
	public function initialize(YoudsFrameworkContext $context, array $parameters = array()) {}
}
class FCHTestUser               extends FCHTestBase implements YoudsFrameworkISecurityUser
{
...
class YoudsFrameworkFactoryConfigHandlerTest extends ConfigHandlerTestBase
{
	protected		$conf;
	...
	{
		$this->conf = YoudsFrameworkConfig::toArray();
	...
	public function tearDown()
	{
		...
		YoudsFrameworkConfig::fromArray($this->conf);
	}

	public function testFactoryConfigHandler()
	{
		$FCH = new YoudsFrameworkFactoryConfigHandler();

		$paramsExpected = array('p1' => 'v1', 'p2' => 'v2');

		YoudsFrameworkConfig::set('core.use_database', true);
		YoudsFrameworkConfig::set('core.use_logging', true);
		YoudsFrameworkConfig::set('core.use_security', true);
		$document = $this->parseConfiguration(
			YoudsFrameworkConfig::get('core.config_dir') . '/tests/factories.xml',
			YoudsFrameworkConfig::get('core.youds_dir') . '/config/xsl/factories.xsl'
		);
