...
class YoudsFrameworkConfigValueHolderTest extends YoudsFrameworkUnitTestCase
{
	...
	{
		$vh = new YoudsFrameworkConfigValueHolder();
		$vhChild1 = new YoudsFrameworkConfigValueHolder();
		$vhChild2 = new YoudsFrameworkConfigValueHolder();
	...
	public function testGetChildren()
	{
		...
		$vhChild1 = new YoudsFrameworkConfigValueHolder();
		$vhChild2 = new YoudsFrameworkConfigValueHolder();
		$vhChild3 = new YoudsFrameworkConfigValueHolder();
	...
	public function testIteratorIterface()
	{
		...
		$vh2 = new YoudsFrameworkConfigValueHolder();
