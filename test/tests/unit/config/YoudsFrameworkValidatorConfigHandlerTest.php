...
class YoudsFrameworkValidatorConfigHandlerTest extends ConfigHandlerTestBase
{
	protected function createValidationManager($environment) {
		$VCH = new YoudsFrameworkValidatorConfigHandler();
		$document = $this->parseConfiguration(
			YoudsFrameworkConfig::get('core.config_dir') . '/tests/validators.xml',
			YoudsFrameworkConfig::get('core.youds_dir') . '/config/xsl/validators.xsl',
			$environment
		);
