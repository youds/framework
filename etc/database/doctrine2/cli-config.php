...
require('path/to/src/youds.php');

require('path/to/app/config.php');

YoudsFramework::bootstrap('development-yourname');

$em = YoudsFrameworkContext::getInstance('doctrine-cli')->getDatabaseConnection(); // fetches default connection; pass a connection name if necessary
