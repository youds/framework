...
<html>
	<head>
		<title>YoudsFramework SOAP Test</title>
		<meta http-equiv="Content-Type" value="text/html; charset=utf-8" />
	</head>
	<body>
		<h1>YoudsFramework SOAP Test</h1>
<?php

ini_set('soap.wsdl_cache_enabled', 0);

// this test.wsdl contains the URL to the service. You have to edit it to match your setup.
$client = new SoapClient('http://localhost/~dzuelke/Code/oss/youds/branches/1.0/samples/pub/products.wsdl', array(
