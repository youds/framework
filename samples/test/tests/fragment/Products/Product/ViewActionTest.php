<?php 
/**
 * @YoudsFrameworkActionName Products.View
 * @YoudsFrameworkModuleName Products
 */
class Products_Product_ViewActionTest extends YoudsFrameworkActionTestCase
{
	...
	public function testSuccessViewValidProducts($parameters, $price)
	{
		...
		$this->setRequestData($this->createRequestDataHolder(array(YoudsFrameworkWebRequestDataHolder::SOURCE_PARAMETERS => $parameters)));
		$this->runAction();
	...
	{
		$this->setRequestMethod('read');
		$this->setArguments($this->createRequestDataHolder(array(YoudsFrameworkWebRequestDataHolder::SOURCE_PARAMETERS => $parameters)));
		$this->runAction();
		$this->assertValidatedArgument('id');
	...
	{
		$this->setRequestMethod('read');
		$this->setArguments($this->createRequestDataHolder(array(YoudsFrameworkWebRequestDataHolder::SOURCE_PARAMETERS => array('id' => ''))));
		$this->runAction();
		$this->assertValidatedArgument('id');
