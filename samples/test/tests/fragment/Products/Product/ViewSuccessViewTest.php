...
class Products_Product_ViewSuccessViewTest extends YoudsFrameworkViewTestCase
{
	...
	{		
		$this->setArguments($this->createRequestDataHolder(array(YoudsFrameworkWebRequestDataHolder::SOURCE_PARAMETERS => array('product_name' => 'spam'))));
